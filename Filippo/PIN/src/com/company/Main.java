...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        //inizializzo array random con cifre da 1 a 3
        for (int i = 0; i < x.length; i++) {
        ...
        /* stampa codifica corretta solo per varificare che sia effettivamente corretta
        System.out.println();
        for (int i = 0; i < pin.length; i++) {
        ...
        boolean verifica = uguale(y, codifica);
        if (verifica) {
